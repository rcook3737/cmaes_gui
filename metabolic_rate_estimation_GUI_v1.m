...
save(sprintf('metabolic_rate_est_%s_%s_%s_gen%d_speed%s.mat',fileInfo.controller,...
        fileInfo.subjectID,fileInfo.date,gen_num,fileInfo.speed),'t','vco2_rate','vo2_rate','x_star','mean_squared_error','y_bar','y_meas')
